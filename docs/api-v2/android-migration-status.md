...
| Settings | `/api/v2/settings/contract/capabilities`, `/api/v2/settings/values/effective`, `/api/v2/settings/values/{key}`, `/api/v2/settings/subtitle-appearance/effective`, `/api/v2/settings/device/subtitle-appearance`, `/api/v2/settings/overlay-config` | migrated |
