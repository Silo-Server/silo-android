...
class TvProfileSelectionScreenSourceTest {
    private val source = java.io.File(
        "src/androidMain/kotlin/org/siloserver/silo/tv/ui/screens/profiles/TvProfileSelectionScreen.kt",
    ).readText()
    ...
    fun profilePickerUsesTvosHeaderCopyAndUtilityChips() {
        ...
        assertFalse(
            ...
            "Existing profile management is intentionally hidden on Android TV.",
        )
    }
